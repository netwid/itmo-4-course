...
keytool -genkeypair -alias service1 -keyalg RSA -keysize 2048 -validity 365 -keystore ${SERVICE1_PATH}/service1.jks \
...
keytool -certreq -alias service1 -file ${SERVICE1_PATH}/service1.csr -keystore ${SERVICE1_PATH}/service1.jks -storepass changeit \
  -ext san=ip:172.20.0.2
keytool -gencert -alias rootCA -infile ${SERVICE1_PATH}/service1.csr -outfile ${SERVICE1_PATH}/service1.crt \
...
keytool -import -trustcacerts -alias service1 -file ${SERVICE1_PATH}/service1.crt -keystore ${SERVICE1_PATH}/service1.jks -storepass changeit

# service2
SERVICE2_PATH=service2/src/main/resources
keytool -genkeypair -alias service2 -keyalg RSA -keysize 2048 -validity 365 -keystore ${SERVICE2_PATH}/service2.jks \
...
keytool -certreq -alias service2 -file ${SERVICE2_PATH}/service2.csr -keystore ${SERVICE2_PATH}/service2.jks -storepass changeit \
  -ext san=ip:172.20.0.4
keytool -gencert -alias rootCA -infile ${SERVICE2_PATH}/service2.csr -outfile ${SERVICE2_PATH}/service2.crt \
  -keystore rootCA.jks -storepass changeit -validity 365 \
  -ext san=ip:172.20.0.4
keytool -import -trustcacerts -alias rootCA -file rootCA.crt -keystore ${SERVICE2_PATH}/service2.jks -storepass changeit
keytool -import -trustcacerts -alias service2 -file ${SERVICE2_PATH}/service2.crt -keystore ${SERVICE2_PATH}/service2.jks -storepass changeit

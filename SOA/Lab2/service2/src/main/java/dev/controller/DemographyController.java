...
public class DemographyController {
    ...
    public Percentage hairColor(@PathVariable("color") String color) throws JsonProcessingException {
    ...
    public Percentage eyeColor(@PathVariable("color") String color) throws JsonProcessingException {
        var response = new Percentage();
    ...
    private int query(String query) throws JsonProcessingException {
        ...
        PersonsResponseDTO person = xmlMapper.readValue(response, PersonsResponseDTO.class);
